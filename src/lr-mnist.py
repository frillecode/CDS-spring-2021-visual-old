...
class LogRegMNIST():
    ...
    def calc_eval_metrics(self, clf):
    ...
    def save_eval_metrics(self, cm):
        ...
        outpath = os.path.join("out", "assignment4", f"{self.args['filename']}.txt")
        # Writing file
...
if __name__=="__main__":
    main()
    print("[INFO] The evaluation metrics has been saved in 'out/assignment4/'.")
